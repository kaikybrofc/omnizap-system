...
async function ensureDirectories() {
  try {
    ...
    logger.error(
      `[StickerCommand.ensureDirectories] Erro ao criar diretórios necessários: ${error.message}`,
      {
