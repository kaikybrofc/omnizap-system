...
- (nenhum)
- argumentos:
- texto | tipo: string | opcional | validacao: texto livre ou conteúdo de mensagem citada | default: null | posicao: 0
- pre_condicoes:
- requer_grupo: nao
- requer_admin: nao
- requer_admin_principal: nao
...
- limits:
- usage_description: sujeito a timeouts internos de renderizacao
- rate_limit.max: null
...
- faq_queries: como usar citar, o que faz citar, comando citar
