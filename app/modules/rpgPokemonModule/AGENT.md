...
- limite_de_uso: subcomandos permitidos pelo modulo
- local_de_uso:
- privado
- grupo
- metodos_de_uso:
...
- engajamento
- argumentos:
- acao | tipo: string | obrigatorio | validacao: subcomando permitido do RPG | default: null
- parametros | tipo: array<string> | opcional | validacao: dependente da ação | default: []
- pre_condicoes:
- requer_grupo: nao
- requer_admin: nao
...
- (nao informado)
- observabilidade:
- evento_analytics: whatsapp_command_rpg
