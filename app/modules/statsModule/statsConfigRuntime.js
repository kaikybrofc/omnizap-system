...
export const getStatsModuleConfig = () => runtime.getModuleConfig();

export const resolveStatsCommandName = (command) => runtime.resolveCommandName(command);
export const getStatsCommandEntry = (command) => runtime.getCommandEntry(command);
export const listEnabledStatsCommands = () => runtime.listEnabledCommands();

export const getStatsTextConfig = () => {
  const config = getStatsModuleConfig();
...
export const getStatsUsageText = (command, { commandPrefix = '/', header, variant } = {}) => {
  const entry = getStatsCommandEntry(command);
