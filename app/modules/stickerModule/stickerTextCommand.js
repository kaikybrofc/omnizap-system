  ...
  try {
    ...
    setImmediate(() => {
      addStickerToAutoPack({
        ...
        .catch((collectError) => {
          logger.warn(
            `processTextSticker Falha ao coletar figurinha automática: ${collectError.message}`,
          );
        });
    });
  } catch (error) {
  ...
  try {
    ...
    setImmediate(() => {
      addStickerToAutoPack({
        ...
        .catch((collectError) => {
          logger.warn(
            `processBlinkingTextSticker Falha ao coletar figurinha automática: ${collectError.message}`,
          );
        });
    });
  } catch (error) {
