...
import { renderCatalogClientScript } from './stickerPackCatalogClientScriptTemplate.js';
...
const renderCatalogHtml = ({ initialPackKey }) => {
  ...
  const clientConfigJson = jsonForInlineScript(clientConfig);
...
<body>
  ...
  <script>${renderCatalogClientScript(clientConfigJson)}</script>
</body>
</html>`;
};
